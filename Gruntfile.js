  ...
  grunt.initConfig({
    ...
    concat: {
      rb: {
        ...
        files: {
          '.compass/lib/test-prototype-style-guide.rb': ['.compass/.template/style-guide.rb']
        }
      },
      gemspec: {
        options: {
        ...
        files: {
          '.compass/test-prototype-style-guide.gemspec': ['.compass/.template/style-guide.gemspec']
        }
      }
    },
    ...
    exec: {
      ...
      ext: {
        cmd: 'cd .compass && bundle exec gem build test-prototype-style-guide.gemspec && mv test-prototype-style-guide-' + userConfig.client.version + '.gem ../test-prototype-style-guide-' + userConfig.client.version + '.gem && cd ..'
      },
      install: {
        cmd: 'gem install test-prototype-style-guide-' + userConfig.client.version + '.gem && rm test-prototype-style-guide-' + userConfig.client.version + '.gem'
      },
      weinre: {
